...
export default function VisionSection() {
  return (
    <section className="section-divider relative overflow-hidden bg-black py-20 text-white sm:py-24">
      ...
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6">
        <div className="border-l-2 border-[#F0B90B]/30 pl-6 sm:pl-10">
          <p className="text-2xl font-light italic leading-relaxed tracking-tight text-white/90 sm:text-3xl md:text-4xl lg:text-5xl">
